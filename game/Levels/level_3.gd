...
func _on_next_level_button_pressed() -> void:
	Statistics.register_total_time(2, total_time)
	Statistics.register_hints(2, hint1_used, hint2_used)
	Statistics.register_all_clicks(2, all_clicks)
	Statistics.register_all_interactions(2, interactions)
	Statistics.register_missplacement_error(2, missplacements)
	Statistics.register_correct_pieces(2, total_correct_placements)
